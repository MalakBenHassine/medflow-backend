...
class Invoice(models.Model):
    ...
    tenant = models.ForeignKey('clinics.Clinic', null=True, blank=True, on_delete=models.SET_NULL, related_name='invoices')  # Pour multi-tenant
...
class Payment(models.Model):
    ...
    amount = models.DecimalField(max_digits=10, decimal_places=2)
    payment_method = models.CharField(max_length=255, default='Stripe')  # Intégration en mode test
